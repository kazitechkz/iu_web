export enum SubStepActionTypes {
    OnSubStep = "[SubStep Action] On SubStep",
    OnSubStepSuccess = "[SubStep Action] On SubStep Success",
    OnSubStepFailure = "[SubStep Action] On SubStep Failure",
