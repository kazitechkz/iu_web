...
@Component({
  selector: 'app-iutube-card-horizontal',
  templateUrl: './iutube-card-horizontal.component.html',
  styleUrls: ['./iutube-card-horizontal.component.scss']
})
export class IutubeCardHorizontalComponent {
